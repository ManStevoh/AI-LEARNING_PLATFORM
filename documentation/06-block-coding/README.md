...
5. [block-project-data-model.md](./block-project-data-model.md) — saved project JSON (`1.0` legacy + `1.1` envelope)
...
Related ADR: [0004-use-blockly-for-visual-programming.md](../../architecture/decisions/0004-use-blockly-for-visual-programming.md)
